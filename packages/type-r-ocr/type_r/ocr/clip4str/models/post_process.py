...
def clip_post_process(
    ...
    p_y_prod, p_y, p_y_ind = top_k_candidate_v2(
        probs, K=K, num_samples=num_samples, K2=K2
    )
    ...
    final_p_y, final_ind, final_pred = (
        p_y[ind, ...],
        p_y_ind[ind, ...],
        preds[ind.item()],
    )
...
if __name__ == "__main__":
    ...
    # print(sum_x / 1000)
    probs = torch.tensor(
        [[0.1, 0.2, 0.7], [0.2, 0.7, 0.1], [0.7, 0.1, 0.2]], dtype=torch.float
    )
