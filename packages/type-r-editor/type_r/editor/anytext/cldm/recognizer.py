...
from ..ocr_recog.vocab import PPOCR_KEYS_V1
...
def get_char_dict_from_textfile(character_dict_path):
    character_str = []
...
class TextRecognizer(object):
    def __init__(self, args, predictor):
        ...
        if "rec_char_dict_path" in args.keys():
            self.chars = get_char_dict_from_textfile(args.rec_char_dict_path)
        else:
            self.chars = self.get_char_dict()
